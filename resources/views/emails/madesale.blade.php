...
@section('content')
    ...
    <p style="font-size: 16px; color: #333;">{{ __('emails.YouMadeSale') }} 🎉</p>
    <br>
    <a href="{{ route('referrals') }}" style="background: #fe4801; padding: 15px 25px; color: white; font-weight: bold; text-decoration: none; border-radius: 5px;"> {{ __('emails.ViewDashboard') }} </a>
    <br>
    <br>
    {{-- <p style="font-size: 16px;  color: #333;">You can view your total commissions in your dashboard in the “Referrals” section and request payment at any time.</p> --}}
